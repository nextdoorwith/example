...
import example.mybatis.entity.MstEmployee;
import example.mybatis.entity.MstEmployeeExample;
...
public interface MstEmployeeMapper {
     ...
     */
    @Required
    MstEmployee selectByPrimaryKeyAddedTest(@Param("cid") String cid, @Param("eid") String eid);
